...
public class CustomerLogInController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<CustomerDTO> readCustomer= new CustomerServiceImpl().showCustomers();
            for (CustomerDTO readCustomers : readCustomer) {
                if(username.equals(readCustomers.getUserName()) && password.equals(readCustomers.getPassword())){
                    HttpSession session = request.getSession();
                    Integer b = (Integer) session.getAttribute("s");
                    if (null == b) {
                        b = new Integer(0);
                    }
                    b =1;
