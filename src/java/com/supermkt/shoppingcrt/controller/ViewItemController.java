 ...
 */
@WebServlet(name = "ViewItemController", urlPatterns = {"/ViewItemController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (ItemDTO readItem : readItems) {
                out.print("<tr>");
                out.print("<td>");
                out.print(readItem.getItemId());
                out.print("</td>");
                out.print("<td>");
                out.print(readItem.getItemCategory());
                out.print("</td>");
                out.print("<td>");
                out.print(readItem.getItemName());
                out.print("</td>");
                out.print("<td>");
                out.print(readItem.getItemQty());
                out.print("</td>");
                out.print("<td>");
                out.print(readItem.getUnitPrice());
                out.print("</td>");
            }
            out.print("</table>");
        }
